                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add_user" method="POST" action="<?= base_url('admin/profile') ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="margin: 0 auto;">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" required value="<?= $user->first_name ?>" name="firstname" placeholder="Enter First Name" required />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" required value="<?= $user->surname ?>" name="surname" placeholder="Enter Last Name" required />
                                            </div>
                                            <div class="form-group">
